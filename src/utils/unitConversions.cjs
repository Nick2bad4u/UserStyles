/**
 * Unit conversion utility functions. Pure functions with no DOM dependencies —
...
/**
 * Convert metres to feet, returning a two-decimal-place string. Returns `0` for
 * invalid input (NaN, null, or empty string).
 *
 * @param {number | string | null} meters - Distance in metres.
 *
 * @returns {string | number} The feet value as a fixed-precision string, or
 *   `0`.
 */
