/**
 * Pure cycling mathematics utility functions. Extracted from
 * cyclingCalculators.js — no DOM dependencies, fully testable.
 *
 * @module cyclingMath
 */
 ...
 *
 * Zones use the common percentage-of-max approach: Zone 1: 50–60 %, Zone 2:
 * 60–70 %, Zone 3: 70–80 %, Zone 4: 80–90 %, Zone 5: 90–100 %.
 *
 ...
 *
 * @param {number} rollingCoefficient - Rolling resistance coefficient (e.g.
 *   0.005).
 ...
 * @param {number} wheelDiameter - Wheel diameter (arbitrary units matching the
 *   0.002 factor).
 *
 * @returns {string} Speed in km/h, two decimal places.
 */
